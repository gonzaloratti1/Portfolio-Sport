                    ...
                    <tbody>
                        {data.map(item => (
                            <tr key={item.id} className="bg-white">
                                <td className='border px-4 py-2'><Image src={item.image} alt={item.text} className="block m-0 w-10 h-10  mx-auto" /></td>
                                <td className='border px-4 py-2  mx-auto'>{item.text}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
